...
# midi2xairosc.py
#
"""Bridge MIDI commands to Behringer X-Air / MIDAS M-AIR OSC commands."""
...
log = logging.getLogger('midi2xairosc')
BACKEND_MAP = {
...
def main(args=None):
    ...
    log.debug("Attaching MIDI input handler.")
